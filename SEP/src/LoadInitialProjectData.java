...
public class LoadInitialProjectData {
    ...
    {   MyDate birthday = new MyDate(12,9,2020);
        ...
        Task task1 = new Task("task1","This is task 1",12.0,deadline, 0, "Ended", assignedEmployee1);
        Task task2 = new Task("task2","This is task 2",12.0,deadline, 1, "Started", assignedEmployee1);
        Task task3 = new Task("task3","This is task 3",12.0,deadline, 2, "Ended", assignedEmployee2);
