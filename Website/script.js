/*globals document: false window: false  XMLHttpRequest: false console: false*/
...
function getRows() {
    ...
    xmlhttp.open("get", "project1requirement.xml", true);
...
function showResult(xmlhttp) {
    ...
    var rowData = xmlDoc.getElementsByTagName("requirement");
